...
export const VerifyCode = () => {
    ...
    return (
        <ClientLayout>
            <Row align="middle" justify="center" className="h-3/6">
                <div className="flex w-1/2 flex-col items-center justify-center px-8 rounded-3xl  bg-[#242424]" style={{ margin: "auto" }}><br></br>
                    <Typography.Title
                        level={3}
                    ...
                    <p>Vui lòng kiểm tra email và nhập mã để xác thực tài khoản.</p>
