...
function UpdateProfile() {
    ...
    return (
        <div className="mb-8 flex flex-col items-center justify-center gap-8">
            <div className="relative mt-32 w-[50%] rounded-2xl px-8 py-12 backdrop-blur-3xl md:w-full px-8 ${className} bg-[#242424]">
                <Typography.Title
                        ...
                        <Col span={24}>
                            ...
                            >
                                <Row>
                                    ...
                                    >
                                        <text className="container mx-auto text-[18px] h-full flex items-center text-center indent-8 leading-[3rem]">Email :</text>
                                    </Col>
                                    <Col
                                        xs={24}
                                        sm={12}
                                    ...
                                    >
                                        <Input
                                            ...
                                            {...(isEdit ? { value: userProfile?.email } : { value: userProfile?.email ?? '' })}
                                            data-testid="email"
                                        />
                                    </Col>
                                </Row>
                            ...
                            >
                                <Row>
                                    <Col
                                        ...
                                        xxl={6}
                                    >
                                        <text className="container mx-auto text-[18px] h-full flex items-center text-center indent-8 leading-[3rem]">Họ và Tên đệm :</text>
                                    </Col>
                                    <Col
                                        xs={24}
                                        sm={12}
                            ...
                            >
                                <Row>
                                    <Col
                                        ...
                                        xxl={6}
                                    >
                                        <text className="container mx-auto text-[18px] h-full flex items-center text-center indent-8 leading-[3rem]">Tên :</text>
                                    </Col>
                                    <Col
                                        xs={24}
                                        sm={12}
                            ...
                            >
                                <Row>
                                    <Col
                                        ...
                                        xxl={6}
                                    >
                                        <text className="container mx-auto text-[18px] h-full flex items-center text-center indent-8 leading-[3rem]">Số điện thoại :</text>
                                    </Col>
                                    <Col
                                        xs={24}
                                        sm={12}
